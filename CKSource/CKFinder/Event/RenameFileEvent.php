...
class RenameFileEvent extends CKFinderEvent
{
     ...
     */
    #[Pure]
    public function __construct(CKFinder $app, protected RenamedFile $renamedFile)
    {
    ...
    public function getRenamedFile(): RenamedFile
    {
     ...
     * Returns the renamed file object.
     */
    public function getFile(): RenamedFile
    {
        return $this->renamedFile;
    }
}
