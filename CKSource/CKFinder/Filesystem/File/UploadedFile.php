...
class UploadedFile extends File
{
     ...
     */
    protected UploadedFileBase $uploadedFile;
     ...
     */
    protected string|false $tempFilePath;
    ...
    public function isValid(): bool
    {
        return $this->uploadedFile &&
            $this->tempFilePath &&
            is_readable($this->tempFilePath) &&
            is_writable($this->tempFilePath);
    }
    ...
    {
        $ext = !str_contains($this->fileName, '.') ? null : $this->getExtension();
    ...
    {
        return fopen($this->tempFilePath, 'rb');
    }
     ...
     */
    public function isAllowedHtmlFile(): bool
    {
    ...
    {
        return false !== @getimagesize($this->tempFilePath);
    }
