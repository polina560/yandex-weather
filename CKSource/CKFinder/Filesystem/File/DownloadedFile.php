...
use Exception;
use CKSource\CKFinder\Exception\{FileNotFoundException, InvalidExtensionException, InvalidNameException};
...
class DownloadedFile extends ExistingFile
{
     ...
     * Constructor.
     */
    public function __construct(string $fileName, CKFinder $app)
    {
