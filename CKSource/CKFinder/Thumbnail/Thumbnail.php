...
use CKSource\CKFinder\{Exception\FileNotFoundException,
    ...
    ResizedImage\ResizedImageAbstract,
...
class Thumbnail extends ResizedImageAbstract
{
     ...
     */
    protected array $adjustedSizeInfo;
    ...
    public function create(): bool
    {
        ...
        $image = Image::create(
            $sourceBackend->read($sourceFilePath),
        ...
        $image->resize(
            $this->adjustedSizeInfo['width'],
            $this->adjustedSizeInfo['height'],
